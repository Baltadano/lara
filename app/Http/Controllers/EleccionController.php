...
class EleccionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('eleccion/list',compact('elecciones'));////////eleccion o elecciones??????
    }
    ...
    function validateData(Request $request)
    {
        $request->validate([
            ...
            //puede que hagan falta validar que tengan forzozamente 
            // rellenar los demas campos
        ]);
    }
